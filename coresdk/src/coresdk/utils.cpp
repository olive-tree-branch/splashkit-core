...
namespace splashkit_lib
{
    ...
    {
        std::string path = path_to_resource(filename, kind);
    ...
    void draw_button(window dest, const std::string &text, font dialog_font, int font_size, const rectangle &rect)
    {
    ...
    void display_dialog(const std::string &title, const std::string &msg, font output_font, int font_size)
    {
        ...
        std::string prompt = "Press enter or OK to continue...";
        float ok_x, ok_y;
